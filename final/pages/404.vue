...
<template>
  <div>
    ...
    >
        ...
        <div class="relative">
          <div class="absolute">
            <div class="">
              ...
              <p class="my-2 text-gray-800 dark:text-indigo-600">
      ...
      <div>
        <img
          src="https://images.unsplash.com/photo-1556722283-71e39f3077b1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y29mZmVlJTIwc2hha2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
        />
      </div>
    </div>
  </div>
