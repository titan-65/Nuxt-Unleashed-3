    ...
    <form class="w-full max-w-sm mx-auto" @submit.prevent="addItem">
      ...
      <div class="mb-4">
        ...
        <input
          ...
          id="description_head"
          type="text"
          placeholder="Enter description head"
        />
      </div>
      <div class="mb-4">
      ...
      <div class="flex items-center justify-center">
        <button
          class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-underline"
          type="submit"
        >
          Submit
        </button>
